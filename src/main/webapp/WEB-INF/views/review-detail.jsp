    ...
    <c:otherwise>
      <div class="board-card mb-4" style="display:grid;grid-template-columns:100px 1fr;gap:14px;align-items:start;">
        ...
        <div style="min-width:0;">
          <h1 class="mb-1" style="font-family:'Gowun Batang',serif;font-size:22px;font-weight:700;">${novel.title}</h1>
          <p class="mb-1" style="font-size:13px;color:var(--muted);">원작: ${novel.authorName} &middot; ${novel.platform}</p>
          ...
          <p style="font-size:14px;line-height:1.7;white-space:pre-line;">${novel.summary}</p>
        </div>
      </div>
          ...
          <c:forEach var="r" items="${reviews}">
            <div class="review-item mb-2">
              <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                  <span class="fw-bold" style="font-size:14px;">${r.nickname}<c:if test="${r.isAuthor}"> ✒️</c:if></span>
              ...
              <p class="mb-2" style="font-size:14px;line-height:1.7;">${r.reviewText}</p>
              <c:choose>
