...
<main class="container-xl py-4" style="max-width:520px;">
  ...
  <form method="post" action="${pageContext.request.contextPath}/mypage/author-apply">
    <div class="mb-3">
      ...
      <input type="text" name="penName" class="form-control" value="<c:out value='${application.penName}'/>" required maxlength="100" />
    </div>
    <div class="mb-3">
      <label class="form-label">대표 작품명 <span class="text-danger">*</span></label>
      <input type="text" name="workTitle" class="form-control" value="<c:out value='${application.workTitle}'/>" required maxlength="255" />
    </div>
    <div class="mb-3">
      <label class="form-label">연재 플랫폼 <span class="text-muted" style="font-size:12px;">(선택)</span></label>
      <input type="text" name="platform" class="form-control" value="<c:out value='${application.platform}'/>"
    ...
    <div class="mb-3">
      ...
      <textarea name="description" class="form-control" rows="5"><c:out value="${application.description}"/></textarea>
    </div>
